...
import {aabb_isect_2d, inrect_2d} from 'math';
import {Timer} from 'util';

import {Vector2, Vector3, Matrix4} from 'vectormath';
...
//        pos[1] += c.velpan.pan[1];
  ...
  build_draw(canvas, isVertical, cache_frame=undefined) {
    ...
    //do clipping/scissor at top element
    if (this.parent == undefined) {
      var g = G.g;
    ...
    //this.canvas.push_scissor(pos, size);
